...
namespace DataVisualization.Plotter
{
    public class DataPlotter : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            //add x label
            title = Instantiate(Text, new Vector3(normalize(xMid, xMax, xMin), normalize(yMin, yMax, yMin), normalize(zMin, zMax, zMin)) * plotScale, Quaternion.Euler(90, 0, 0));
            title.transform.parent = PointHolder.transform;
            ...
            title.transform.localScale = new Vector3(0.1f, 0.1f, 0.1f) * plotScale;
            //add z label
            title = Instantiate(Text, new Vector3(normalize(xMin, xMax, xMin), normalize(yMin, yMax, yMin), normalize(zMid, zMax, zMin)) * plotScale, Quaternion.Euler(90, 90, 0));
            title.transform.parent = PointHolder.transform;
            title.GetComponent<TextMesh>().text = zName;
            title.transform.name = "z-label";
            title.transform.localScale = new Vector3(0.1f, 0.1f, 0.1f) * plotScale;
            //add y label
            title = Instantiate(Text, new Vector3(normalize(xMin, xMax, xMin), normalize(yMid, yMax, yMin), normalize(zMax, zMax, zMin)) * plotScale, Quaternion.Euler(0, 0, 90));
            title.transform.parent = PointHolder.transform;
